      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.75rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: '0.25rem 0 0 0' }}>
            Cảnh báo hạn trả sách, phê duyệt và các tin tức quan trọng từ thư viện
          </p>
        </div>
            ...
            return (
              <div 
                ...
                style={{
                  ...
                  backgroundColor: isUnread ? 'rgba(99, 102, 241, 0.04)' : 'var(--bg-card)',
                  display: 'flex',
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', marginBottom: '0.35rem' }}>
                    <h3 style={{ fontSize: '0.975rem', fontWeight: isUnread ? 700 : 500, color: 'var(--text-primary)', margin: 0 }}>
                      {notif.message}
                    </h3>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
                      ...
                      {isUnread && (
                        <span className="badge-dot" style={{ backgroundColor: 'var(--primary-light)', width: '8px', height: '8px', flexShrink: 0 }}></span>
                      )}
                    </div>
                  </div>
